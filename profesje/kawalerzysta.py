...
umiejkip = ["Broń Biała (Podstawowa)", "Jeździectwo(Konie)", "Język (Bitewny)", "Odporność", "Opieka nad Zwierzętami", "Oswajanie", "Percepcja", "Sztuka Przetrwania"]
...
umiejkip = ["Broń Biała (Kawaleryjska)", "Broń Zasięgowa (Prochowa)", "Charyzma", "Mocna Głowa", "Opanowanie", "Plotkowanie"]
...
umiejkip = ["Intuicja", "Dowodzenie", "Wiedza (Sztuka Wojenna)", "Zastraszanie"]
...
umiejkip = ["Hazard", "Wiedza (Heraldyka)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
