...
umiejkip = ["Intuicja", "Mocna Głowa", "Percepcja", "Plotkowanie", "Pływanie", "Wiedza (Lokalna)", "Wiedza (Szlaki Rzeczne)", "Wioślarstwo"]
...
umiejkip = ["Broń Biała (Podstawowa)", "Charyzma", "Język (Dowolny)", "Nawigacja", "Opanowanie", "Występy (Gawędziarstwo)"]
...
umiejkip = ["Targowanie", "Wiedza (Lokalna)", "Wiedza (Wraki)", "Zastraszanie"]
...
umiejkip = ["Dowodzenie", "Żeglarstwo"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
