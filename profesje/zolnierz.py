...
umiejkip = ["Atletyka", "Broń Biała (Podstawowa)", "Język (Bitewny)", "Muzyka (Bęben albo Piszczałka)", "Odporność", "Opanowanie", "Unik", "Wspinaczka"]
...
umiejkip = ["Broń Biała (Dowolna)", "Broń Zasięgowa (Dowolna)", "Hazard", "Mocna Głowa", "Plotkowanie", "Sztuka Przetrwania"]
...
umiejkip = ["Dowodzenie", "Intuicja", "Leczenie", "Percepcja"]
...
umiejkip = ["Nawigacja", "Wiedza (Sztuka Wojenna)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
