...
umiejkip = ["Badania Naukowe", "Język (Klasyczny)", "Mocna Głowa", "Odporność", "Percepcja", "Targowanie", "Wiedza (Prawo)", "Wiedza (Teologia)"]
...
umiejkip = ["Przekupstwo", "Charyzma", "Plotkowanie", "Intuicja", "Język (Gildii)", "Sekretne Znaki (Gildii)"]
...
umiejkip = ["Sztuka (Pisarstwo)", "Wiedza(Dowolna)", "Występy (Przemowy)", "Zastraszanie"]
...
umiejkip = ["Opanowanie", "Wiedza (Polityka)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
