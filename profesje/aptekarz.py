...
umiejkip = ["Język (Klasyczny)", "Leczenie", "Mocna Głowa", "Rzemiosło (Aptekarstwo)", "Rzemiosło (Truciciel)", "Wiedza (Chemia)", "Wiedza (Medycyna)", "Wiedza (Rośliny)"]
...
umiejkip = ["Charyzma", "Język (Gildii)", "Percepcja", "Plotkowanie", "Targowanie", "Wiedza (Nauka)"]
...
umiejkip = ["Badania Naukowe", "Dowodzenie", "Intuicja", "Sekretne Znaki (Cechu)"]
...
umiejkip = ["Jeździectwo (Konie)", "Zastraszanie"]
