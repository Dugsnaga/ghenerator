...
umiejkip = ["Atletyka", "Mocna Głowa", "Odporność", "Plotkowanie,Pływanie", "Sztuka Przetrwania", "Unik", "Wioślarstwo"]
...
umiejkip = ["Broń Zasięgowa (Miotana)", "Broń Zasięgowa (Oplątująca)", "Hazard", "Wiedza (Lokalna)", "Wiedza (Szlaki Rzeczne)", "Zastawianie Pułapek"]
...
umiejkip = ["Broń Biała (Drzewcowa)", "Intuicja", "Percepcja", "Przekonywanie"]
...
umiejkip = ["Wiedza (Ludowa)", "Występy (Gawędziarstwo)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
