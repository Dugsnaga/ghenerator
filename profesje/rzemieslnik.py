...
umiejkip = ["Atletyka", "Opanowanie", "Mocna Głowa", "Unik", "Odporność", "Wycena", "Skradanie (Miasto)", "Rzemiosło (Dowolne)"]
...
umiejkip = ["Charyzma", "Język (Cechu)", "Percepcja", "Plotkowanie", "Targowanie", "Wiedza (Lokalna)"]
...
talenty0 = ["Wytwórca (Dowolne Rzemiosło)"]
