...
umiejkip = ["Broń Biała (Podstawowa)", "Charyzma", "Hazard", "Mocna Głowa", "Plotkowanie", "Targowanie", "Unik", "Wycena"]
...
umiejkip = ["Intuicja", "Opanowanie", "Percepcja", "Rzemiosło(Grawer)", "Sekretne Znaki (Złodziei)", "Zastraszanie"]
...
umiejkip = ["Przekupstwo", "Wiedza (Lokalna)", "Wiedza (Sztuka)", "Występy (Gawędziarstwo)"]
...
umiejkip = ["Badania Naukowe", "Wiedza (Heraldyka)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
