...
umiejkip = ["Broń Biała (Dowolna)", "Dowodzenie", "Leczenie", "Modlitwa", "Odporność", "Opanowanie", "Wiedza (Teologia)", "Unik"]
...
umiejkip = ["Broń Biała (Dowolna)", "Broń Zasięgowa(Dowolna)", "Charyzma", "Język (Bitewny)", "Występy(Przemawianie)", "Zastraszanie"]
...
umiejkip = ["Intuicja", "Jeździectwo (Konie)", "Percepcja", "Opieka nad zwierzętami"]
...
umiejkip = ["Mocna Głowa", "Wiedza (Sztuka Wojenna)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
...
wyp1 = ["broń biała (Dowolna)", "księga (Religia)", "skórzany kaftan", "symbol religijny", "szata"]
