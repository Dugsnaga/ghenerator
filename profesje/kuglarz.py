...
umiejkip = ["Atletyka", "Charyzma", "Kuglarstwo (Dowolne)", "Muzyka (Dowolna)", "Plotkowanie", "Targowanie", "Występy (Dowolne)", "Zwinne Palce"]
...
umiejkip = ["Broń Biała (Podstawowa)", "Broń Zasięgowa (Miotana)", "Jeździectwo (Dowolne)", "Kuglarstwo (Dowolne)", "Muzyka (Dowolna)", "Występy (Dowolne)"]
...
umiejkip = ["Język (Dowolny)", "Opieka nad Zwierzętami", "Sztuka (Pisarstwo)", "Tresura (Dowolne)"]
