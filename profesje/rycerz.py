...
umiejkip = ["Atletyka", "Broń Biała (Kawaleryjska)", "Jeździectwo(Konie)", "Leczenie", "Opieka nad Zwierzętami", "Oswajanie", "Rzemiosło (Podkuwanie Koni)", "Wiedza (Heraldyka)"]
...
umiejkip = ["Broń Biała (Dowolna)", "Język (Bitewny)", "Odporność", "Opanowanie", "Unik", "Zastraszanie"]
...
umiejkip = ["Charyzma", "Mocna Głowa", "Dowodzenie", "Wiedza (Sztuka Wojenna)"]
...
umiejkip = ["Sekretne Znaki (Zakonu Rycerskiego)", "Wiedza (Dowolna)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
...
wyp2 = ["broń biała (Dowolna)", "kopia", "rumak z siodłem i uprzężą", "zbroja płytowa z hełmem"]
