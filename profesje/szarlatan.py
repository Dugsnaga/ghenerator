...
umiejkip = ["Charyzma", "Hazard", "Mocna Głowa", "Plotkowanie", "Przekupstwo", "Targowanie", "Występy (Gawędziarstwo)", "Zwinne Palce"]
...
umiejkip = ["Intuicja", "Opanowanie", "Percepcja", "Unik", "Wycena", "Występy (Aktorstwo)"]
...
umiejkip = ["Język (Grypsera)", "Wiedza (Heraldyka)", "Otwieranie Zamków", "Sekretne Znaki (Złodziei)"]
...
umiejkip = ["Badania Naukowe", "Wiedza (Genealogia)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
...
talenty3 = ["Język (Grypsera)", "Wiedza (Heraldyka)", "Otwieranie Zamków", "Sekretne Znaki (Złodziei)"]
