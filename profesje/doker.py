...
umiejkip = ["Atletyka", "Broń Biała (Podstawowa)", "Mocna Głowa", "Odporność", "Plotkowanie", "Pływanie", "Unik", "Wspinaczka"]
...
umiejkip = ["Hazard", "Percepcja", "Przekupstwo", "Skradanie (Miasto)", "Występy (Gawędziarstwo)", "Zastraszanie"]
...
umiejkip = ["Dowodzenie", "Intuicja", "Opanowanie", "Wycena"]
...
umiejkip = ["Charyzma", "Wiedza (Podatki)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
...
talenty4 = ["Charyzma", "Wiedza (Podatki)"]
