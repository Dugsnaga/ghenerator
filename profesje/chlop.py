...
umiejkip = ["Atletyka", "Broń Biała (Bijatyka)", "Mocna Głowa", "Odporność", "Opieka nad Zwierzętami", "Plotkowanie", "Sztuka Przetrwania", "Wiedza (Lokalna)"]
...
umiejkip = ["Broń Biała (Podstawowa)", "Powożenie", "Rzemiosło (Dowolne)", "Targowanie", "Unik", "Występy (Gawędziarstwo)"]
...
umiejkip = ["Charyzma", "Dowodzenie", "Przekupstwo", "Zastraszanie"]
...
umiejkip = ["Intuicja", "Wiedza (Historia)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
...
talenty4 = ["Mistrz Rzemiosła (Dowolne)", "Mówca", "Znawca (Wiedza Lokalna)", "Zręczny"]
