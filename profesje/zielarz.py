...
umiejkip = ["Odporność", "Oswajanie", "Percepcja", "Pływanie", "Rzemiosło (Zielarz)", "Sztuka Przetrwania", "Wiedza (Zioła)", "Wspinaczka"]
...
umiejkip = ["Leczenie", "Mocna Głowa", "Opanowanie", "Plotkowanie", "Targowanie", "Wiedza (Lokalna)"]
...
umiejkip = ["Dowodzenie", "Intuicja", "Rzemiosło (Trucizny)", "Wiedza (Medycyna)"]
