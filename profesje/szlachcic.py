...
umiejkip = ["Broń Biała (Szermiercza)", "Hazard", "Dowodzenie", "Mocna Głowa", "Muzyka (Dowolna)", "Przekupstwo", "Wiedza (Heraldyka)", "Zastraszanie"]
...
umiejkip = ["Broń Biała (Parująca)", "Charyzma", "Język(Klasyczny)", "Jeździectwo (Konie)", "Plotkowanie", "Wiedza (Lokalna)"]
...
umiejkip = ["Intuicja", "Język (Dowolny)", "Percepcja", "Wiedza(Polityka)"]
...
umiejkip = ["Tropienie", "Wiedza (Dowolna)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
