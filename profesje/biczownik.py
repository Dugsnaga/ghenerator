...
umiejkip = ["Broń Biała (Korbacz)", "Intuicja", "Leczenie", "Odporność", "Sztuka Przetrwania", "Unik", "Wiedza (Sigmar)", "Zastraszanie"]
...
umiejkip = ["Atletyka", "Broń Zasięgowa (Proca)", "Język (Klasyczny)", "Opanowanie", "Sztuka (Ikony)", "Wiedza (Imperium)"]
...
umiejkip = ["Charyzma", "Język (Dowolny)", "Percepcja", "Wiedza (Teologia)"]
...
umiejkip = ["Dowodzenie", "Występy (Przemowy)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
