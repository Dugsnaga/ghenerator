...
umiejkip = ["Broń Biała (Podstawowa)", "Mocna Głowa", "Odporność", "Pływanie", "Sztuka Przetrwania", "Unik", "Wioślarstwo", "Wspinaczka"]
...
umiejkip = ["Intuicja", "Nawigacja", "Opanowanie", "Percepcja", "Przekupstwo", "Zastawianie Pułapek"]
...
umiejkip = ["Broń Zasięgowa (Kusza)", "Plotkowanie", "Skradanie (Wieś)", "Zastraszanie"]
...
umiejkip = ["Dowodzenie", "Wiedza (Szlaki Wodne)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
