...
umiejkip = ["Atletyka", "Broń Biała (Podstawowa)", "Hazard", "Mocna Głowa", "Opanowanie", "Odporność", "Sztuka Przetrwania", "Zastraszanie"]
...
umiejkip = ["Broń Zasięgowa (Łuk)", "Leczenie", "Percepcja", "Skradanie (Wieś)", "Unik", "Wiedza (Lokalna)"]
...
umiejkip = ["Dowodzenie", "Intuicja", "Jeździectwo (Konie)", "Plotkowanie"]
...
umiejkip = ["Umiejętności: Charyzma", "Wiedza (Imperium)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
