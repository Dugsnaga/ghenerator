...
umiejkip = ["Broń Biała (Dwuręczna)", "Intuicja", "Odporność", "Opanowanie", "Percepcja", "Pływanie", "Sztuka Przetrwania", "Wiedza (Lokalna)"]
...
umiejkip = ["Broń Biała (Podstawowa)", "Mocna Głowa", "Rzemiosło (Materiały Wybuchowe)", "Sekretne Znaki (Górników)", "Wspinaczka", "Wycena"]
...
umiejkip = ["Plotkowanie", "Rzemiosło (Inżynieria)", "Skradanie (Podziemia)", "Wiedza (Geologia)"]
