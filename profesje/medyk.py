...
umiejkip = ["Leczenie", "Odporność", "Opanowanie", "Percepcja", "Plotkowanie", "Powożenie", "Przekupstwo", "Zwinne Palce"]
...
umiejkip = ["Charyzma", "Język (Gildii)", "Rzemiosło (Cyrulik)", "Targowanie", "Wiedza (Anatomia)", "Wiedza(Medycyna)"]
...
umiejkip = ["Badania Naukowe", "Dowodzenie", "Mocna Głowa", "Zastraszanie"]
...
umiejkip = ["Wiedza (Szlachta)", "Występy (Taniec)"]
for um in umiejkip:
    if um in umiejkip0:
        um = um + " "
    umiejkip0[um] = -2
